  ...
  <div class="wxPop">
    <div class="zzc" v-if="showWx">
      <div class="wxCons">
        ...
        <img src="/static/images/me/wxPopImg.png" class="wxPopImg">
...
<style scoped>
  .zzc{position: fixed;width: 100%;height: 100%;background: rgba(0,0,0,0.5);display: flex;align-items: flex-start;justify-content: center;top:0;left: 0;z-index: 1001;}
  ...
  .wxConsTop{display: flex;align-items: center;justify-content: space-between;background: linear-gradient(to right,#ffa264,#ffa86f,#ffaf7d,#ffb383);padding:0.4rem 0.2rem 0.2rem 0.2rem;border-radius: 0.2rem 0.2rem 0 0;border-bottom: 1px solid rgba(255,255,255,0.5);}
  ...
  .wxLeftTxt{font-size: 0.22rem;color: #ff3e4e;text-align: center;line-height: 0.36rem;margin-top: 0.2rem;font-weight: 500;}
  .wxRightBox{display: flex;align-items: center;justify-content: space-between;border: 1px solid #ff3e4e;border-radius: 1rem;padding: 0.1rem 0.2rem;margin-bottom: 0.2rem;}
  .wxRightBox p{font-size: 0.28rem;color: #ff3e4e;}
